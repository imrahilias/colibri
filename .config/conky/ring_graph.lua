...
function conky_ring_graph()
   ...
   cpufreq[cursec]    = tonumber(conky_parse('${freq}')) / 1700 -- in % of 1700 mhz
   ...
   down[cursec]       = tonumber(conky_parse('${downspeedf wlan0}')) / 10000 -- in % of 10000 kib
   up[cursec]         = tonumber(conky_parse('${upspeedf wlan0}')) / 1000 -- in % of 1000kib
